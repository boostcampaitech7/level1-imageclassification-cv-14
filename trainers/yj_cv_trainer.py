...
#         # 데이터 로더 생성
#             train_loader = DataLoader(train_subset, batch_size=32,num_workers=8, shuffle=True)
#             val_loader = DataLoader(val_subset, batch_size=32,num_workers=8, shuffle=False)
