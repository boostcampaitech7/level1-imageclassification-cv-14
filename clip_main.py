...
from transforms.clip_transform import ClipImageTransform
...
def main():
    ...
    train_transform = ClipImageTransform(transform_name=config.transform_name)
    val_transform = ClipImageTransform(transform_name=config.transform_name)
